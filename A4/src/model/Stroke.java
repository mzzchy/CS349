...
public class Stroke {
	...
	public Element createElement(Document doc) {
		Element strokeNode = doc.createElement("stroke");
		
		Element pointListNode = doc.createElement("pointList");
		strokeNode.appendChild(pointListNode);
		for(Point p: pointList){
			Element pointNode = doc.createElement("point");
			//TODO:
			pointNode.appendChild(doc.createTextNode(""+p.x+" "+p.y));
			pointListNode.appendChild(pointNode);
		}
		
		//Ask frame to handle itself
		Element frameNode = frame.createElement(doc);
		strokeNode.appendChild(frameNode);
